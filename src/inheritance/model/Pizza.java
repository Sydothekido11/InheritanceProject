...
public abstract class Pizza implements Foods
{
	...
	public int compareTo(Object compared)
	{
		...
		{
			if(this.deliciousness(this.criticRating) < ((Foods) compared).deliciousness(this.criticRating))
			{
				comparedValue = -1;
			}
			else if(this.deliciousness(this.criticRating) > ((Foods) compared).deliciousness(this.criticRating))
			{
				comparedValue = 1;
			}
			else
